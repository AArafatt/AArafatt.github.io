...
My research weaves together Natural Language Processing (NLP), Clustering, Multimodal AI, Social Media Analysis and Explainable Deep Learning to create innovative solutions for low-resource languages.
</p>

## 1. Natural Language Processing (NLP)
<p style="text-align:justify; color:black; font-family:Georgia">
NLP for Social Good (Toxicity, Hate Speech, Cyberbully)
</p>

### Related Papers:
+ <span style="font-family:Trebuchet MS; color:black;"><span style="color:#6E2C00">Bridging Dialects: Translating Standard Bangla to Regional Variants Using Neural Models</span>. Md. Arafat Alam Khandaker, Ziyan Shirin Raha, Bidyarthi Paul, Tashreef Muhammad. <span style="color:green;"><em>27th International Conference on Computer and Information Technology (ICCIT), 2024</em></span>. [[PDF]](https://arxiv.org/pdf/2501.05749)</span>

+ <span style="font-family:Trebuchet MS; color:black;"><span style="color:#6E2C00">FanSpeak: A Bangla Dataset for Multi-Class Toxicity Detection in Sports Discourse</span>. <span style="color:green;"><em>Dataset & manuscript in progress</em></span>.</span>

## 2. Explainable Deep Learning in Computer Vision
<p style="text-align:justify; color:black; font-family:Georgia">
Applying XAI with deep learning to medical diagnosis and agriculture.
</p>
...
## 3. Multimodal AI
<p style="text-align:justify; color:black; font-family:Georgia">
Fusion of text–image to detect fake news in low-resource settings.
</p>
...
### Ongoing Work:
+ <span style="font-family:Trebuchet MS; color:black;"><span style="color:#6E2C00">FanSpeak</span>: A Dataset on Toxicity in Sports-Related Online Discourse.</span>
+ <span style="font-family:Trebuchet MS; color:black;"><span style="color:#6E2C00">SarcFormer</span>: A Transformer-Based Framework for Sarcasm Analysis.</span>
+ <span style="font-family:Trebuchet MS; color:black;"><span style="color:#6E2C00">CoT-Driven Explainable Counter-Response Generation</span> for Personalized Bullying Mitigation.</span>
