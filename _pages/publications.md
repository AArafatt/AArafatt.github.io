...
<div style="font-size: 1.8em; color: #333; border-bottom: 2px solid #ccc; margin-bottom: 15px; padding-bottom: 5px;">2025</div>
  ...
  [<a style="color:red;" href="#" onclick="$('#paper1_abstract').toggle();return false;"><font size="3">Abstract</font></a>] [[<span style ="color:red"><font size="3">PDF</font></span>](https://www.sciencedirect.com/science/article/pii/S2667096825000291)] [<a style="color:red;" href="#" onclick="$('#paper1_bib').toggle();return false;"><font size="3">Citation bib</font></a>] 
  ...
  <br>
    <span style="color:black;font-family:Georgia">
      <font size="3"><strong>Conference: </strong>
        <em><a href="https://ecce2025.cuet.ac.bd/" target="_blank">ECCE-2025</a></em>
      </font>
    </span>
  <br>
  [<a style="color:red;" href="#" onclick="$('#paper2_abstract').toggle();return false;"><font size="3">Abstract</font></a>] [[<span style ="color:red"><font size="3">PDF</font></span>](https://www.researchgate.net/publication/392216960_Multimodal_Classification_of_Software_Issue_Reports_Using_CLIP_A_Fine-Tuned_Approach_for_Bug_and_Feature_Detection)] [<a style="color:red;" href="#" onclick="$('#paper2_bib').toggle();return false;"><font size="3">Citation bib</font></a>] 
  ...
  <div id="paper2_abstract" class="abstract" style="display:none;">
      <p style="text-align:justify; color:black;font-family:Monaco;"> 
          <font size="3">
            Efﬁciently identifying software bugs is critical toaccelerate software development processes. Traditional methods,which frequently depend on manual review or constraint-drivenmechanisms, require a signiﬁcant amount of time, susceptibleto mistakes made by humans, and unable to scale effectivelywith the growing complexity of modern software systems. Withtexts, code snippets, and images from well-known repositories likeVS Code, Flutter, Roslyn, and Kubernetes in total comprised of4304 samples, this paper presents a new multimodal approachthat uses Contrastive Language-Image Pretraining (CLIP) andits ViT-B/32 variant to effectively address this problem. We exper-imented with several CLIP variants, including ViT-B/32, RN50,RN101, RN50x4, ViT-B/16, ViT-L/14, and RN50x64, and observedthat ViT-B/32 performed well under zero-shot settings, with anaccuracy of 56.6%, precision of 54.08%, recall of 53.96% andF1-score of 54.02%, showing the usefulness of general-purposemodels in task-speciﬁc situations. We performed k-fold cross-validation and hyperparameter tuning on the ViT-B/32 variant,which improved the model’s ability to classify software issues withan 18.8% improvement in accuracy, 19.1% in precision, 20.14%in recall, and 19.6% in F1-score over its zero-shot performance.These ﬁndings demonstrate a scalable framework for multimodalclassiﬁcation that goes beyond bugs and features. This frameworkhas potential uses in issue prioritization, automated softwaremaintenance, and productivity tools. These ﬁndings emphasizethe beneﬁts of using multimodal AI models, such as CLIP, totackle practical software engineering problems, providing newinsights and a solid basis for further developments in this ﬁeld.
          </font>
      </p>
  </div>
  ...
  📌 [<span style="color:Blue;font-family:Trebuchet MS;">**Navigating High-Dimensional Data with Advanced Clustering Algorithms**</span>](https://www.researchgate.net/profile/Shamim-Akhter-6/publication/392212584_Navigating_High-Dimensional_Data_with_Advanced_Clustering_Algorithms/links/6839a95d6b5a287c3048456c/Navigating-High-Dimensional-Data-with-Advanced-Clustering-Algorithms.pdf) (<span style="color:red"><strong>Conference</strong></span>)<br>
  <span style="color:black;font-family:Georgia">
    <font size="3"><strong>Authors</strong>: Ziyan Shirin Raha, <strong style="color:green">Md Arafat Alam Khandaker</strong>, Md Zahid Hossain, Shamim Akhter</font>
  </span>
  <br>
    <span style="color:black;font-family:Georgia">
      <font size="3"><strong>Conference: </strong>
  ...
  <br>
  [<a style="color:red;" href="#" onclick="$('#paper3_abstract').toggle();return false;"><font size="3">Abstract</font></a>] [[<span style ="color:red"><font size="3">PDF</font></span>](https://www.researchgate.net/publication/392212584_Navigating_High-Dimensional_Data_with_Advanced_Clustering_Algorithms)] [<a style="color:red;" href="#" onclick="$('#paper3_bib').toggle();return false;"><font size="3">Citation bib</font></a>] 
  ...
  <br>
    <span style="color:black;font-family:Georgia">
      <font size="3"><strong>Conference: </strong>
        <em><a href="https://ieeexplore.ieee.org/xpl/conhome/11021691/proceeding" target="_blank">ICCIT 2024</a></em>
      </font>
    </span>
  <br>
  ...
  <span style="color:black;font-family:Georgia">
    <font size="3"><strong>Authors</strong>: <strong style="color:green">Md. Arafat Alam Khandaker</strong>, Ziyan Shirin Raha, Salehin Bin Iqbal, M.F. Mridha, Jungpil Shin</font>
  </span>
  <br>
    <span style="color:black;font-family:Georgia">
      <font size="3"><strong>Conference: </strong>
